...
grob_loadMod_noCurt.plot2 <- 
  arrangeGrob(grobs = 
                list(rbind(g_vre_loadMod_noCurt, g_vre_share_loadMod_w_noCurt2, size = "first"), 
