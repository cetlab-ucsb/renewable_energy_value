...
plot.allLines.byVREsplit <- function(results.input, main_variable, scenarios.to.include, scenarios.labels, positions, plot.colors, plot.linetype, plot_title, y_min, y_max, y_label, y_label_sec, y_sec_multiplier){
...
## Capacity value of VRE
p_capacity_value_newTech <- plot.allLines.byVREsplit(results.processed, "capacity_value_pMWh", scenarios.to.include.vre, scenarios.labels.vre, positions, colors_RD3, linetype_vre2, "Average Capacity Value of VRE", 0, 50, "USD/MWh of VRE", "INR/kWh of VRE", INR_USD/1000)
p_capacity_value_newTech

## Energy value of VRE
p_energy_value_newTech <- plot.allLines.byVREsplit(results.processed, "energy_value_pMWh", scenarios.to.include.vre, scenarios.labels.vre, positions, colors_RD3, linetype_vre2, "Average Energy Value of VRE", 0, 50, "USD/MWh of VRE", "INR/kWh of VRE", INR_USD/1000)
