...
scenarios <- c("base", "coal_55mingen", "wind10LC", "wind20LC", "wind30LC", "solar10LC", "solar20LC", "solar30LC", "wind30LC_solar30LC", "wind120HH_solar1A", "battery15", "battery30", "battery15B25LC", "battery30B25LC", "battery15B50LC", "battery30B50LC") 
```
...
scenarios.to.include.vre <- c("base", "wind30LC", "solar30LC", "wind30LC_solar30LC", "high_cost_coal")
scenarios.labels.vre <- c("base case", "low cost wind", "low cost solar", "low cost wind + solar", "low cost wind + solar + high cost coal")
linetype_vre <- c("solid", rep("dashed", 3))
...
p_vre + scale_linetype_manual(labels = scenarios.labels.vre, values = c("solid", rep("dashed", 3)))
...
p_sys_cost <- plot.facet.allLines(results.processed, "system_cost_add_pMWh_load", scenarios.to.include.vre, scenarios.labels.vre, positions, colors_RD7, linetype_vre, "Average Additional Cost of VRE", -5, 15, "USD/MWh of Load", "INR/kWh of Load", INR_USD/1000)
p_sys_cost
