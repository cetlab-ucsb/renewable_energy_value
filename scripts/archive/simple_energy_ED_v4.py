...
dispatch_cost_annual = pd.DataFrame() # annual dispatch cost for every day
...
for d in range(1,3):
    ...
    dispatch_cost_annual = dispatch_cost_annual.append(dispatch_cost_df, ignore_index=True)
