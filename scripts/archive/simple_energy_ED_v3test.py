...
genVRE_all = pd.read_csv("vre_gen" + ".csv", sep=',')
...
genGAS_minGen_cf = 0.4 ## For now, the entire GAS fleet will have the same minimum CF. 
genOTHER_minGen_cf = 0.7 ## For now, the entire OTHER fleet will have the same minimum CF. 
#genCOAL_minGen_cf = 0.55 ## For now, the entire COAL fleet will have the same minimum CF. 
